...
import {Box, FormControl, InputLabel, MenuItem, Select, Pagination, SelectChangeEvent} from '@mui/material';
...
interface PaginationComponentProps {
    ...
    onRowsPerPageChange: (event: SelectChangeEvent<string>, child: ReactNode) => void
}
